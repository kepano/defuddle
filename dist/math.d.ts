...
export declare const isBlockMath: (el: Element) => boolean;
export declare const createStandardMathElement: (mathData: MathData | null, latex: string | null, isBlock: boolean) => Element;
