...
- wenyan-lite: "Component re-renders often because each render creates a new object reference. Wrap it with useMemo."
- wenyan-full: "Each render creates a new object reference, hence re-render; wrapping with useMemo prevents it."
- wenyan-ultra: "New ref → re-render. useMemo wrap."
